            ...
            <div class="col-lg-3 d-lg-block d-none">
                <div class="announcement-call-wrapper">
                    <div class="announcement-call">
                        <a class="announcement-text text-white" href="tel:+1-078-2376">Call: 0123456789</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-3 d-lg-block d-none">
                        ...
                        <ul class="main-menu list-unstyled justify-content-center">
                            <li class="menu-list-item nav-item has-dropdown active">
                                <div class="mega-menu-header">
                                    <a class="nav-link text-nowarp" href="/">
                                        Trang Chủ
                                    </a>
                                </div>
                            </li>
                            ...
                            <li class="menu-list-item nav-item has-megamenu">
                                <div class="mega-menu-header">
                                    <a class="nav-link" href="/ve-tham-quan">
                                        Vé Tham Quan
                                    </a>
                                </div>
                            </li>
            ...
            <div class="container">
                <form action="#" class="search-form d-flex align-items-center">
                    ...
                    <div class="search-input mr-4">
                        <input type="text" placeholder="Nhập thông tin tìm kiếm...." autocomplete="off">
                    </div>
